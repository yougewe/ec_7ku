...
if (!defined('INIT_NO_USERS'))
{
    ...
    if (isset($smarty))
    {
        ...
        $smarty->assign('ecs_theme_path', 'themes/' . $_CFG['template']);   //引用文件时使用
        $smarty->assign('categories',      get_categories_tree());          // 分类树,全局使用
        $smarty->assign('helps',           get_shop_help());                // 网店帮助,全局使用
...
/* 判断是否支持 Gzip 模式，被注释2015-3-20@youge */
